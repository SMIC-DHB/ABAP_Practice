...
CLASS ltc_demo_howard_unit_test_td1 DEFINITION FINAL FOR TESTING
  ...
  PRIVATE SECTION.
    ...
    DATA: cut TYPE REF TO zcl_demo_howard_unit_test_td1.
...
CLASS ltc_demo_howard_unit_test_td1 IMPLEMENTATION.
  ...
  METHOD setup.
    ...
    cut = NEW #( combined_provider ).
    cut->zif_demo_howard_unit_test_td1~set_data( VALUE #( ( customer_number = '00001' full_name = |Last Name#1 First Name#1| amount = 1000 date = '20000101' )
  ...
  METHOD invoice_amount.
    cl_abap_unit_assert=>assert_equals( act = cut->zif_demo_howard_unit_test_td1~get_invoice_amount( '00001' ) exp = 1999 ).  "From set Data 1000 + combined_amount(999) => 1999
    cl_abap_unit_assert=>assert_equals( act = cut->zif_demo_howard_unit_test_td1~get_invoice_amount( '00002' ) exp = 2999 ).  "From set Data 1000 + combined_amount(999) => 1999
  ENDMETHOD.
