...
*    cl_abap_unit_assert=>assert_equals( act = cut->zif_demo_howard_unit_test~determine_if_leap_year( 1999 ) exp = abap_false ).
    cl_abap_unit_assert=>assert_false( act = cut->zif_demo_howard_unit_test~determine_if_leap_year( 1997 ) ).
    cl_abap_unit_assert=>assert_false( act = cut->zif_demo_howard_unit_test~determine_if_leap_year( 1900 ) ).
    cl_abap_unit_assert=>assert_false( act = cut->zif_demo_howard_unit_test~determine_if_leap_year( 1999 ) ).
  ENDMETHOD.

  METHOD verify_discount_by_10.
    cl_abap_unit_assert=>assert_equals( act = cut->zif_demo_howard_unit_test~discount_by_10( 100 ) exp = 90 ).
    cl_abap_unit_assert=>assert_equals( act = cut->zif_demo_howard_unit_test~discount_by_10( 150 ) exp = 135 ).
    cl_abap_unit_assert=>assert_equals( act = cut->zif_demo_howard_unit_test~discount_by_10( 200 ) exp = 180 ).
  ENDMETHOD.

  METHOD verify_discount_by_20.
    cl_abap_unit_assert=>assert_equals( act = cut->zif_demo_howard_unit_test~discount_by_20( 100 ) exp = 80 ).
    cl_abap_unit_assert=>assert_equals( act = cut->zif_demo_howard_unit_test~discount_by_20( 150 ) exp = 120 ).
    cl_abap_unit_assert=>assert_equals( act = cut->zif_demo_howard_unit_test~discount_by_20( 200 ) exp = 160 ).
  ENDMETHOD.

  METHOD verify_combined_amount_leap.
    cl_abap_unit_assert=>assert_equals( act = cut->zif_demo_howard_unit_test~get_combined_amount( initial_amount = 100
                                                                                                  date = '20000101' ) exp = 183 ). "103 + 80

    cl_abap_unit_assert=>assert_equals( act = cut->zif_demo_howard_unit_test~get_combined_amount( initial_amount = 1000
  ...
  METHOD verify_combined_amount_notleap.
    ...
    cl_abap_unit_assert=>assert_equals( act = cut->zif_demo_howard_unit_test~get_combined_amount( initial_amount = 2000
